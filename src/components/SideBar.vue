...
<template>
  <div class="h-full">
    <el-menu
      :collapse="true"
      default-active="/home"
      class="h-full side-bar"
      router
    >
      <el-menu-item index="/person">
        <el-avatar :size="25">{{ store.state.currentUser.userName }}</el-avatar>
...
<style scoped>
.side-bar{
  background: rgb(78,68,247);
  background: linear-gradient(184deg, rgba(78,68,247,1) 27%, rgba(207,112,255,1) 95%);
  border: 0px;
}
</style>
